...
#define BSP_CAN_USE_CAN hcan
    ...
    HAL_StatusTypeDef bsp_can_Sendmessage_int16(CAN_HandleTypeDef *hcan, int16_t StdId, int16_t *Can_Send_Data); // CAN总线数据发送函数
    HAL_StatusTypeDef bsp_can_Sendmessage(CAN_HandleTypeDef *hcan, int16_t StdId, uint8_t *Can_Send_Data);       // CAN总线数据发送函数
